...
var update = function () {
    ...
    if (enemyBotDistance < evadeThreshold) {
        ...
        if (enemyBotDistance == 5)
            tryLayMine();
        else if (enemyBotDistance == 4 && percentChance(90))
            tryLayMine();
        else if (enemyBotDistance == 3 && percentChance(60))
            tryLayMine();
        else if (enemyBotDistance == 2 && percentChance(40))
            tryLayMine();
